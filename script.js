...
`;
  ...
  type(LETTER, () => choice.classList.remove("hidden"), letterBox);
}
...
document.getElementById("yesBtn").onclick = () => {
  ...
  upsideMsg.textContent = `
Sometimes I feel like I’m standing in the Upside Down,
watching you glow on the other side.

You laugh so easily with everyone else,
and I’m scared that with me…
there are quiet moments where we don’t know what to say.

I’m scared that I’m not exciting enough.
Not loud enough.
Not enough.

But even in that fear,
even when the world feels cold and strange,
I don’t want us to disappear.

I don’t want an ending.
I want us to survive.
I want us to hold the rope,
even when the lights start flickering.

If there’s a monster coming,
I want to face it with you.
`;

  upsideMsg.classList.remove("hidden");
  setTimeout(() => reply.classList.remove("hidden"), 4000);
};
